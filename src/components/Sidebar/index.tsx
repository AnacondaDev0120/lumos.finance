                    ...
                    <picture> 
                        ...
                        <div className="contenedor__nav">
                            ...
                            <div className="navegacion__principal">
                                ...
                                {/* <a href="/farms" className="nav__item"> <span className="nav__icon fas fa-hand-holding-usd" /> Farms</a> */}

                                {/* <a href="/pools" className="nav__item"> <span className="nav__icon fas fa-hand-holding-usd" /> Pools</a> */}
